...
describe("build content", () => {
  ...
  it("makes Gondolin and Doriath the named signature spears of the Porcupine build", () => {
    ...
    expect(porcupine.plan).toMatch(/possible to forge both spears at the 100′ forge.*third charge.*Shortbow of the Marchwardens/i)
    ...
    expect(opening.priorities.join(" ")).toMatch(/third forge charge.*Shortbow of the Marchwardens.*utility bow/i)
