  ...
  return <div className="site-shell">
    ...
    <header className="site-header">
      <div className="container header-inner">
        <Link to="/" className="brand" aria-label="Sil-Q Builds home"><span aria-hidden="true">@</span><strong>Sil-Q Builds</strong></Link>
        ...
        <div className="mobile-menu">
          <Sheet>
            ...
            <SheetContent><div className="sheet-brand"><span>@</span><strong>Sil-Q Builds</strong></div><NavLinks mobile pathname={location.pathname} /></SheetContent>
          </Sheet>
        </div>
      </div>
    </header>
    ...
    <footer className="site-footer">
      <div className="container footer-line"><span>Unofficial Sil-Q 1.5 guide.</span><a href="https://github.com/sil-quirk/sil-q/blob/master/Sil-Q%20v1.5.0.pdf" target="_blank" rel="noreferrer">Manual</a><a href="https://github.com/sil-quirk/sil-q" target="_blank" rel="noreferrer">Source</a></div>
    </footer>
  </div>
}
