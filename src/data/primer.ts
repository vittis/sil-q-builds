...
export const primerSections: PrimerSection[] = [
  {
    ...
    sourceIds: ["manual", "abilities", "early-build"],
  },
  {
    id: "positioning",
    eyebrow: "Every fight",
  ...
  {
    id: "depth-pacing",
    eyebrow: "The clock moves downward",
    title: "Prepare for the next band of threats",
    intro: "Sil-Q pushes you deeper. The useful question is not whether a character is complete, but whether it can survive the next hundred feet.",
    points: [
      { title: "Early floors teach fundamentals", body: "Establish one attack, one defence, and an exit plan. Gather arrows, light, and identification XP without spending for a hypothetical endgame." },
      { title: "The middle is the equipment test", body: "Around 500′–700′, prioritize reliable light, fire and poison answers, Free Action when available, and a way to disengage from uniques or raukar." },
      { title: "Late game is resource conversion", body: "Carry restoration, healing, speed, elemental resistance, and a crown-removal plan. Saving every consumable is indistinguishable from never finding it." },
    ],
